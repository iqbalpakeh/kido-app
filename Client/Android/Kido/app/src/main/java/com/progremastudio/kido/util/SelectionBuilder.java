...
import static com.progremastudio.kido.util.LogUtils.LOGV;
import static com.progremastudio.kido.util.LogUtils.makeLogTag;
...
public class SelectionBuilder {
    ...
    /**
     * Execute edit using the current internal state as {@code WHERE} clause.
     */
